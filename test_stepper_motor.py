...
def main():
    ...
    try:
        ...
        while True:
            ...
            stepper.move(steps=2200, clockwise=False, delay=0.0005)
            time.sleep(1)

            print("[TEST] Memutar searah jarum jam (200 langkah)")
            stepper.move(steps=1800, clockwise=False, delay=0.0005)
            time.sleep(1)

            print("[TEST] Memutar berlawanan jarum jam (200 langkah)")
            stepper.move(steps=1800, clockwise=True, delay=0.0005)
            time.sleep(1)
